...
//     constructor(public name: string, public bedrooms: number, public bathrooms: number, public doors: number, public windows: number, public garage: boolean, public price: number, public squareFeet: number, public yearBuilt: number, public stories: number) {
//         this.name = name;
//         this.bedrooms = bedrooms;
//         this.bathrooms = bathrooms;
//         this.doors = doors;
